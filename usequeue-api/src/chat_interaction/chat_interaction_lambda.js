...
var OpenAIApi = require('openai').OpenAIApi; // Assuming you have an OpenAI Node.js client library
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var apiKey, openai, userInput, body, response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                apiKey = process.env.OPENAI_API_KEY;
                openai = new OpenAIApi({ key: apiKey });
                userInput = "";
                if (event && event.body) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, openai.complete({
                        prompt: userInput,
